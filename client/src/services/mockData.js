...
export const mockCalendarTrips = [
  {
    id: 501,
    name: 'Paris Trip',
    title: 'Paris Trip',
    ...
    color: '#3b82f6',
    pillClass: 'calendar-pill-upcoming',
    prefixIcon: '✈️',
    suffixIcon: '✈️',
    locationSummary: 'Paris, France',
    description: 'A romantic 5-day getaway exploring the Eiffel Tower, Louvre Museum, and artisan bakeries.',
    budget: 49999,
    currency: 'INR',
    travelerCount: 2,
    coverImageUrl: 'https://images.unsplash.com/photo-1502602898657-3e91760cbb34?auto=format&fit=crop&w=800&q=80',
    stops: [
      { id: 1, cityName: 'Paris', countryName: 'France', order: 1 },
    ],
  },
  {
    id: 502,
    ...
    prefixIcon: '⛺',
    suffixIcon: '⛺',
    locationSummary: 'Sar Pass, Himachal Pradesh',
    description: 'A planned 4-day alpine camping and mountain trail expedition.',
    budget: 8500,
    currency: 'INR',
    travelerCount: 1,
    coverImageUrl: 'https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?auto=format&fit=crop&w=800&q=80',
    stops: [
      { id: 2, cityName: 'Kasol', countryName: 'India', order: 1 },
      { id: 3, cityName: 'Sar Pass', countryName: 'India', order: 2 },
    ],
  },
  {
    id: 503,
    ...
    prefixIcon: null,
    suffixIcon: '📅',
    locationSummary: 'Goa Coastal Break',
    description: 'Active coastal vacation spanning Jan 15 - Jan 22.',
    budget: 18000,
    currency: 'INR',
    travelerCount: 4,
    coverImageUrl: 'https://images.unsplash.com/photo-1512343879784-a960bf40e7f2?auto=format&fit=crop&w=800&q=80',
    stops: [
      { id: 4, cityName: 'North Goa', countryName: 'India', order: 1 },
      { id: 5, cityName: 'South Goa', countryName: 'India', order: 2 },
    ],
  },
  {
    id: 504,
    ...
    color: '#a855f7',
    pillClass: 'calendar-pill-getaways',
    prefixIcon: null,
    suffixIcon: '🏙️',
    locationSummary: 'New York City, USA',
    description: 'Broadway shows, Central Park strolls, and Manhattan skyline dining.',
    budget: 85000,
    currency: 'INR',
    travelerCount: 2,
    coverImageUrl: 'https://images.unsplash.com/photo-1496442226666-8d4d0e62e6e9?auto=format&fit=crop&w=800&q=80',
    stops: [
      { id: 6, cityName: 'New York', countryName: 'USA', order: 1 },
    ],
  },
  {
    id: 505,
    ...
    color: '#f97316',
    pillClass: 'calendar-pill-adventures',
    prefixIcon: '⛩️',
    suffixIcon: '🏮',
    locationSummary: 'Tokyo & Kyoto, Japan',
    description: 'An exciting cultural immersion exploring historic shrines, ramen alleys, and Mount Fuji.',
    budget: 95000,
    currency: 'INR',
    travelerCount: 2,
    coverImageUrl: 'https://images.unsplash.com/photo-1493976040374-85c8e12f0c0e?auto=format&fit=crop&w=800&q=80',
    stops: [
      { id: 7, cityName: 'Tokyo', countryName: 'Japan', order: 1 },
      { id: 8, cityName: 'Kyoto', countryName: 'Japan', order: 2 },
    ],
  },
  {
    id: 506,
    ...
    suffixIcon: '🏙️',
    locationSummary: 'New York City, USA',
    description: 'Second leg winter exploration in Manhattan and Brooklyn.',
    budget: 65000,
    currency: 'INR',
    travelerCount: 2,
    coverImageUrl: 'https://images.unsplash.com/photo-1496442226666-8d4d0e62e6e9?auto=format&fit=crop&w=800&q=80',
    stops: [
      { id: 9, cityName: 'New York', countryName: 'USA', order: 1 },
    ],
  },
];
